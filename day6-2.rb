...
while !duplicates_found
  ...
  if combinations.include? current_layout
    original_index = combinations.index current_layout
    distance_between_duplicates = redistribution_cycles - original_index
...
puts distance_between_duplicates